...
mobilenetv2_1_sample_input = lambda batch_size: torch.empty((batch_size, 3, 32, 32))
mobilenetv2_2_sample_input = lambda batch_size: torch.empty((batch_size, 1280, 4, 4))


@register_expert_class(name="m1", sample_input=mobilenetv2_1_sample_input)
...
@register_expert_class(name="m2", sample_input=mobilenetv2_2_sample_input)
