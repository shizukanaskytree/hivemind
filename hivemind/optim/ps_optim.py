...
from hivemind.averaging import ParameterServerBase
...
# 参考的是 state_averager.py 内的 class TrainingStateAverager(DecentralizedAverager)
# TrainingStateAverager <-> ParamServer
# DecentralizedAverager <-> ParameterServerBase

class ParamServer(ParameterServerBase):
    """
