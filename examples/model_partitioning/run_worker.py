...
from hivemind import DHT, Float16Compression, get_dht_time
from hivemind.optim import WorkerOptimizer
...
class CollaborativeCallback(transformers.TrainerCallback):
    ...
    def on_train_begin(
        ...
        logger.info("Loading state from ps")
        # self.optimizer.load_state_from_peers()
        self.optimizer.load_state_from_ps()
...
def main():
    ...
    optimizer = WorkerOptimizer(
        dht=dht,
        run_id="worker_run_id", #collaboration_args.run_id,
